<header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <span id="detail"><i class='bx bxs-phone-call' style="color: orangered;"></i>&nbsp&nbspCall&nbsp/&nbsp<i
                            class='bx bxl-whatsapp' style="color: greenyellow;">&nbsp</i>WhatsApp :&nbsp+91&nbsp 8700307203 &nbsp&nbsp&nbsp
    ...
    <nav  id="sourav" class="navbar navbar-expand-lg bg-white ">
        <div class="container">
          <a class="navbar-brand" href="#"><img src="{{asset('public/assets/img/logo.jpg')}}" alt=""></a>
