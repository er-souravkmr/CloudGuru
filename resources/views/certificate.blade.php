            ...
            <div class="container">
                <div class="banner-text">
                    <div class="upper-head ">
                        <h2 class="about-head mt-3" data-aos="fade-up" data-aos-duration="600"> Certificates</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                               <li class="breadcrumb-item"><a href="{{route('home')}}"><i class='bx bxs-home'></i></a></li>
                                <li class="breadcrumb-item active text-white" aria-current="page">Certifications</li>
                            </ol>
                        </nav>
                ...
                @foreach ($data as $item)
                    <div class="col-md-3">
                        <div class="trainer-img position-relative">
                            <img src="{{asset('public/uploads/certificate')}}/{{$item->image}}"
